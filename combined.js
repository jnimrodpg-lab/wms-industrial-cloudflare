...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .vertex.selected{fill:#fff2b8;stroke:#ff9b00;stroke-width:5.6;filter:drop-shadow(0 0 8px rgba(255,155,0,.55)) drop-shadow(0 2px 6px rgba(0,0,0,.42))}
    ...
    .edge-guide{stroke:rgba(255,163,46,.98);stroke-width:8;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 0 8px rgba(255,163,46,.38));vector-effect:non-scaling-stroke}
  ...
  @media (max-width:860px){.dashboard-grid{grid-template-columns:1fr;}.kpi-card,.dashboard-card.wide,.dashboard-card.full{grid-column:1/-1;}}
    ...
    body.theme-light .vertex.selected{fill:#ffe9a3;stroke:#b96f00;stroke-width:5.6;filter:drop-shadow(0 0 8px rgba(185,111,0,.28)) drop-shadow(0 2px 6px rgba(0,0,0,.18))}
